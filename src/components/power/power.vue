  ...
  export default {
    ...
    created() {
      if(this.$store.state.sysList[3].role_string.length != 0) {
        if (this.$store.state.sysList[3].role_string[0] != 0 || this.$store.state.sysList[3].role_string[2] != 0 || this.$store.state.sysList[3].role_string[3] != 0) {
          this.sData.lists.push({id:0,name:'环境情况',route:'/power/components/envirCond'})
        }
        if (this.$store.state.sysList[3].role_string[1] != 0 || this.$store.state.sysList[3].role_string[4] != 0 || this.$store.state.sysList[3].role_string[5] != 0 || this.$store.state.sysList[3].role_string[6] != 0) {
          this.sData.lists.push({id:1,name:'监测情况',route:'/power/components/monitorCond'})
        }
      }else {
        this.sData.lists.push({id:0,name:'环境情况',route:'/power/components/envirCond'})
        this.sData.lists.push({id:1,name:'监测情况',route:'/power/components/monitorCond'})
