...
<template>
  <div>
    <div ref="HpadTop" class="tabsDomBox0 h-paddingTop">
      <div class="navCrumbs"><p @click="toHome">首页</p> > 给排水系统 > <span>高位水箱</span></div>
    </div>
    <div class="WaterPump">
  ...
  export default {
    ...
    data() {
      return {
        ...
        FdeviceImages:[
          {src:require('../../../assets/img/WaterSupplyAndDrainage/waterTank_normal.png')},
          {src:require('../../../assets/img/WaterSupplyAndDrainage/waterTank_innormal.png')},
          {src:require('../../../assets/img/WaterSupplyAndDrainage/waterTank_innormal.png')}
        ],
        FdeviceImagesSize:['1.70rem','1.86rem'],
