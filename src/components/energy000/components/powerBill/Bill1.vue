...
export default {
  ...
  methods:{
    ...
    exportReport(){
      if (this.name != '') {
        window.location.href = 'https://tesing.china-tillage.com/pc/2.0/energy/operation/bill/export?sys_menu_id=' + this.$store.state.sysList[18].sys_menu_id + '&user_id=' + this.$store.state.userId + '&project_id=' + this.$store.state.projectId + '&page_type=0' + '&floor_id=' + this.areaId + '&time_start=' + this.time_start + '&time_end=' + this.time_end + '&energy_type=' + this.energy_type + '&pagesize=20' + '&page_number=' + this.table.page + '&name=' + this.name;
      } else {
        window.location.href = 'https://tesing.china-tillage.com/pc/2.0/energy/operation/bill/export?sys_menu_id=' + this.$store.state.sysList[18].sys_menu_id + '&user_id=' + this.$store.state.userId + '&project_id=' + this.$store.state.projectId + '&page_type=0' + '&floor_id=' + this.areaId + '&time_start=' + this.time_start + '&time_end=' + this.time_end + '&energy_type=' + this.energy_type + '&pagesize=20' + '&page_number=' + this.table.page;
      }
    },
    search(){
      this.table.page = 1;
    ...
    requestData(){
      ...
      this.$http.post('pc/2.0/energy/operation/bill/tenant', data, headers).then(res => {
        let data0 = res.data;
